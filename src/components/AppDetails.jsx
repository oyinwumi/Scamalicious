...
const AppDetails = () => {
  return (
    <div className="bg-[#EDEAEA]   relative lg:px-20 px-8 py-14 w-full">
        ...
        <div className="w-full flex flex-wrap gap-5 mt-10 text-center ">
          <div className=" border bg-white  rounded-[40px] p-5 lg:w-[32%] w-full shadow-lg shadow-black">
       ...
       <Link to='/download'>  <button className= "bg-yellow text-center shadow-lg shadow-black text-black w-[224px] h-[56px] border-yellow rounded-lg text-[22px] font-semibold font-font1 items-center  mt-10">Download Now </button></Link>
        </div>
    </div>
  )
}
