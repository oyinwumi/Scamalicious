  ...
  return (
    <div className="bg-white   relative lg:px-20 px-8 py-14 w-full">
        ...
        <div className="w-full flex flex-wrap gap-5 mt-10 text-center ">
          <div className=" border  rounded-[40px] p-5 lg:w-[32%] w-full shadow-lg shadow-black-500">
          ...
          <div className=" border  rounded-[40px] p-5 lg:w-[32%] w-fullshadow-lg shadow-black-500">
            <img src={Scam} alt="" className="items-center mx-auto " />
        ...
        <div className="w-full lg:mx-[40%] mx-[5%]">
