  ...
  return (
    <div className="relative w-full h-full mb-10  " >
        ...
        <div className="lg:px-20 px-8  py-8">
            ...
            <p className="text-xl font-bold font-font1 lg:w-[823px] w-full tracking-widest mt-5">Don’t let scammers take advantage of you! Stay one step ahead with SCAMalicious, the essential mobile application designed to help you make informed decisions and protect yourself from fraud.</p>
