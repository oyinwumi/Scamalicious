  ...
  return (
    <div className="relative w-full h-full mb-10  " >
        ...
        <div className="lg:px-20 px-8  py-8" >
            ...
            <p className="text-xl font-font1 lg:w-[823px] w-full tracking-widest">Don’t let scammers take advantage of you! Stay one step ahead with SCAMalicious, the essential mobile application designed to help you make informed decisions and protect yourself from fraud.</p>
            ...
            <Link to="/download" className=" lg:mt-0 mt-10"> <button className="bg-yellow relative text-white  w-[220px] h-[54px] border-yellow rounded-lg text-[22px] font-semibold font-font1">Download App Now </button></Link>
